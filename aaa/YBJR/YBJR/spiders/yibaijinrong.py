...
from YBJR.items import YBJR_product
...
class YBJR_Spider(Spider):
    ...
    start_urls = conn.getUrls('https://www.pp100.com/front/invest/investHome?currPage=', 1,'&pageSize=&bidStatus=-1&period=0&apr=0&searchType=0', '还款中')
